...
export default function Projects() {
  return (
    ...
    <div className='project'>   
        <a href='https://math-calculator-gnzv-git-master-ondeyomatoke.vercel.app/' target='blank'>
          <div>
      ...
      <div className='project'>
        <a href='https://gift-card-git-master-ondeyomatoke.vercel.app/' target='blank'>
          <div>
      ...
      <div className='project'>
        <a href='https://a-todo-list-git-master-ondeyomatoke.vercel.app/' target='blank'>
          <div>
      ...
      <div className='project'>
        <a href='https://bmi-calculator-git-master-ondeyomatoke.vercel.app/' target='blank'>
          <div>
      ...
      <div className='project'>
        <a href='https://updated-clock-git-master-ondeyomatoke.vercel.app/' target='blank'>
          <div>
      ...
      <div className='project'>
        <a href='https://facebook-landing-page-git-master-ondeyomatoke.vercel.app/' target='blank'>
          <div>
